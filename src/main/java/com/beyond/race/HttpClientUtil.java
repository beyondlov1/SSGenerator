...
public class HttpClientUtil {
    // 依次是代理地址，代理端口号，用户密码
    private static String proxyHost = "64.137.241.42";
    private static int proxyPort = 6550;
    private static String proxyName = "user";
    private static String proxyPwd = "doub.io/sszhfx/*6550";
    ...
    public static void main(String[] args) {
        String withProxy = HttpClientUtil.getWithProxy("https://www.baidu.com", null, "UTF-8");
